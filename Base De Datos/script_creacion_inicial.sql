...
/************************** INI-BORRADO DE TABLAS***************************/
	...
	IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'ICE_CUBES.SERVICIO'))
		DROP TABLE ICE_CUBES.SERVICIO
...
/************************** INI-CREACION DE TABLAS***************************/
	...
	CREATE TABLE ICE_CUBES.SERVICIO(
		SERV_ID INT IDENTITY(1,1) PRIMARY KEY  NOT NULL,
		SERV_NOMBRE NVARCHAR(255),
	)
	...
	--	CRUCERO_MARCA NVARCHAR(255), 
		...
		CRUCERO_SERV_ID INT, --FK SERVICIO
...
-- Creacion de FKs
	...
	ALTER TABLE ICE_CUBES.CRUCERO WITH CHECK ADD
	CONSTRAINT FK_MARCA FOREIGN KEY (CRUCERO_SERV_ID) REFERENCES ICE_CUBES.SERVICIO (SERV_ID)
	ON DELETE NO ACTION ON UPDATE CASCADE
...
BEGIN
	...
	INSERT INTO ICE_CUBES.SERVICIO (SERV_NOMBRE)
	VALUES
	('No definido'), 
	('All Inclusive'), 
	('Solo Desayuno')

	INSERT INTO ICE_CUBES.CRUCERO (CRUCERO_IDENTIFICADOR,CRUCERO_MODELO,CRUCERO_MARCA_ID,CRUCERO_SERV_ID)
...
--IF(OBJECT_ID('ICE_CUBES.eliminarReservasVencidas') IS NOT NULL)
--		DROP PROCEDURE ICE_CUBES.SP_INGRESAR_ROL
--GO
CREATE PROCEDURE ICE_CUBES.eliminarReservasVencidas(@hoy DATE)
AS BEGIN
	BEGIN TRANSACTION
		update GD1C2019.ICE_CUBES.OPERACION
		set OPER_ESTADO = 0
