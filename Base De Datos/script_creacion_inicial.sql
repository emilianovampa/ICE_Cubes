...
/************************** INI-CREACION DE TABLAS***************************/
	...
	CREATE TABLE ICE_CUBES.TRAMO(
		...
		TRAMO_NIVEL INT IDENTITY(1,1) NOT NULL, 
		TRAMO_ORIGEN INT,
		TRAMO_DESTINO INT,
...
-- Creacion de FKs
	...
	--CONSTRAINT FK_COMPRA_CLIENTE FOREIGN KEY (COMPRA_CLIENTE) REFERENCES ICE_CUBES.CLIENTE (CLIE_ID)
	--ON DELETE NO ACTION ON UPDATE CASCADE,
	...
	--CONSTRAINT FK_RESERVA_CLIENTE FOREIGN KEY (RESERVA_CLIENTE) REFERENCES ICE_CUBES.CLIENTE (CLIE_ID)
...
BEGIN
	...
	order by 1;
		--SELECT  M.PASAJE_CODIGO, COUNT(M.PASAJE_CODIGO)
	--FROM GD1C2019.gd_esquema.Maestra M
	--WHERE M.PASAJE_CODIGO IS NOT NULL
	--GROUP BY  M.PASAJE_CODIGO
	--order by 2 DESC;
	...
	INSERT INTO ICE_CUBES.TRAMO(TRAMO_RECO_ID,TRAMO_ORIGEN,TRAMO_DESTINO,TRAMO_PRECIO)
	SELECT distinct m.RECORRIDO_CODIGO,P.PUERTO_ID,P2.PUERTO_ID, m.RECORRIDO_PRECIO_BASE
		FROM GD1C2019.gd_esquema.Maestra M
		JOIN ICE_CUBES.PUERTO P ON P.PUERTO_NOMBRE = M.PUERTO_DESDE
		JOIN ICE_CUBES.PUERTO P2 ON P2.PUERTO_NOMBRE = M.PUERTO_HASTA
		where 
		--m.RECORRIDO_CODIGO = 43820905AND 
...
--	SELECT distinct m.RECORRIDO_CODIGO,m.PUERTO_DESDE,m.PUERTO_HASTA, m.RECORRIDO_PRECIO_BASE
--		FROM GD1C2019.gd_esquema.Maestra M
--		order by 1


--SELECT TOP 1000 [TRAMO_RECO_ID]
--      ,[TRAMO_NIVEL]
--      ,[TRAMO_ORIGEN]
--      ,[TRAMO_DESTINO]
--      ,[TRAMO_PRECIO]
--  FROM [GD1C2019].[ICE_CUBES].[TRAMO]
-- ORDER BY TRAMO_RECO_ID
--FALTA MIGRAR VIAJE PARA LUEGO ACTUALIZAR OPERACION)
	...
	,OPER_PRECIO,OPER_CLIENTE,OPER_CABINA_ID)
